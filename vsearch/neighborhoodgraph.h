...
#ifndef VECTORSEARCH_THIRD_PARTY_SPTAG_NEIGHBORHOODGRAPH_H_
#define VECTORSEARCH_THIRD_PARTY_SPTAG_NEIGHBORHOODGRAPH_H_
        ...
        for (int j = 0; j < TptreeLeafNodes[i].size(); j++) {
          ...
          for (int x = start_index; x < end_index; x++) {
            for (int y = x + 1; y <= end_index; y++) {
              ...
              Utils::AddNeighbor(p2, dist, (m_pNeighborhoodGraph)[p1],
                                         (NeighborhoodDists)[p1],
                                         m_iNeighborhoodSize);
              Utils::AddNeighbor(p1, dist, (m_pNeighborhoodGraph)[p2],
...
#endif //VECTORSEARCH_THIRD_PARTY_SPTAG_NEIGHBORHOODGRAPH_H_

...
#ifndef VECTORSEARCH_THIRD_PARTY_SPTAG_VECTOR_INDEX_H_
#define VECTORSEARCH_THIRD_PARTY_SPTAG_VECTOR_INDEX_H_
...
#endif //VECTORSEARCH_THIRD_PARTY_SPTAG_VECTOR_INDEX_H_

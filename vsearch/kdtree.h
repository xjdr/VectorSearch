...
#ifndef VECTORSEARCH_THIRD_PARTY_SPTAG_KDTREE_H_
#define VECTORSEARCH_THIRD_PARTY_SPTAG_KDTREE_H_
...
#pragma omp parallel for
 ...
 private:
  ...
  int SelectDivisionDimension(const std::vector<float>& varianceValues) const {
    ...
    return topind[Utils::rand_int(num)];
  }
...
#endif //VECTORSEARCH_THIRD_PARTY_SPTAG_KDTREE_H_

...
#ifndef VECTORSEARCH_THIRD_PARTY_SPTAG_QUERY_RESULT_SET_H_
#define VECTORSEARCH_THIRD_PARTY_SPTAG_QUERY_RESULT_SET_H_
...
#endif //VECTORSEARCH_THIRD_PARTY_SPTAG_QUERY_RESULT_SET_H_

...
#ifndef VECTORSEARCH_VSEARCH_DISTANCE_H_
#define VECTORSEARCH_VSEARCH_DISTANCE_H_
...
#define REPEAT(type, ctype, delta, load, exec, acc, result) \
  ...
  */
  ...
  static inline float ComputeDistance(const T* p1, const T* p2, int length,
                                      vsearch::DistCalcMethod distCalcMethod) {
    if (distCalcMethod == vsearch::DistCalcMethod::L2)
...
template <typename T>
float (*DistanceCalcSelector(vsearch::DistCalcMethod p_method))(const T*,
                                                                const T*, int) {
  switch (p_method) {
    case vsearch::DistCalcMethod::Cosine:
      return &(Distance::ComputeCosineDistance);

    case vsearch::DistCalcMethod::L2:
      return &(Distance::ComputeL2Distance);
...
#endif //VECTORSEARCH_VSEARCH_DISTANCE_H_
